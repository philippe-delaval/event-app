...
type IconType = React.ElementType<React.SVGAttributes<SVGSVGElement>>;
                                    ...
                                    <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                                        ...
                                        <nav className="flex flex-1 flex-col">
                                            <ul role="list" className="flex flex-1 flex-col gap-y-7">
                                                        ...
                                                        {navigation.map((item) => (
                                                            <li key={item.name}>
                                                                ...
                                                                >
                                                                    <item.icon
                                                                        className={classNames(
                                                                            item.current ? 'text-primary-orange' : 'text-gray-400 group-hover:text-primary-orange',
                                                                            'h-6 w-6 shrink-0'
                                                                        )}
                                                                        aria-hidden="true"
                                                                    />
                                                ...
                                                <li>
                                                    <div className="text-xs font-semibold leading-6 text-gray-400">Administrateurs</div>
