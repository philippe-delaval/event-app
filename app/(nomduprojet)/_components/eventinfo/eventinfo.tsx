...
function EventInfo({formRef}: EventInfoProps) {
    ...
    return (
        <>
            ...
            {isVisible && (
                <div
                    className="relative isolate flex items-center gap-x-6 overflow-hidden bg-background-grey px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
                    <div
                    ...
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                        <p className="text-sm leading-6 text-gray-900">
                            <strong className="font-semibold">Inscrivez-vous vite à l&#39;évènement, il ne reste
                                que <Counter/> places !</strong>
                        </p>
                        <a
                            href="#"
            ...
            <div className="bg-background-grey">
                <div className="relative isolate">
                    <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                        <div
                            className="mx-auto flex max-w-2xl flex-col gap-16 bg-white/5 px-6 py-12 ring-1 ring-white/10 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-12 xl:gap-x-20 xl:px-20">
                            <iframe
                            ...
                            <div className="w-full flex-auto">
                                ...
                                <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
                                    <div className="mt-2 flex items-center text-sm text-primary-gray">
                                        <MapPinIcon className="mr-1.5 h-5 w-5 flex-shrink-0 text-primary-orange"
                                                    aria-hidden="true"/>
                                        Strasbourg, France
                                    </div>
                                    <div className="mt-2 flex items-center text-sm text-primary-gray">
                                        <CalendarIcon className="mr-1.5 h-5 w-5 flex-shrink-0 text-primary-orange"
                                                      aria-hidden="true"/>
                                        01 Septembre 2023
                                    </div>
                                </div>
