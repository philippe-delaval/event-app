                ...
                <div className="bg-white shadow sm:rounded-lg mt-3">
                  <Switch.Group as="div" className="px-4 py-5 sm:p-6">
                    <Switch.Label
                      ...
                      passive
                    >
                      Engagement requis pour l&#39;inscription à l&#39;événement
                      Apéro Dev
                    </Switch.Label>
                    <div className="mt-2 sm:flex sm:items-start sm:justify-between">
                      <div className="max-w-xl text-sm text-gray-500">
                        <Switch.Description>
                          En cochant cette case, je m&#39;engage à apporter mon
                          propre PC portable avec prise HDMI le jour de
                          l&#39;évènement
                        </Switch.Description>
                      </div>
                ...
                <div className="bg-white shadow sm:rounded-lg mt-3">
                  <Switch.Group as="div" className="px-4 py-5 sm:p-6">
                    <Switch.Label
                      ...
                      passive
                    >
                      Consentement des données personnelles pour
                      l&#39;inscription à l&#39;événement Apéro Dev
                    </Switch.Label>
                    <div className="mt-2 sm:flex sm:items-start sm:justify-between">
                      <div className="max-w-xl text-sm text-gray-500">
                        <Switch.Description>
                          En cochant cette case, j&#39;accepte que mes données
                          personnelles soient recueillies et traitées
                          conformément à la politique de confidentialité. Je
                          suis informé(e) que ces données sont recueillies par
                          ATI4 Group dans le but de gérer mon inscription à
                          l&#39;évènement Apéro Dev et que je dispose d&#39;un
                          droit d&#39;accès, de rectification et de suppression
                          de mes données en contactant l&#39;adresse email de
                          contact pour la gestion des données.
                        </Switch.Description>
                      </div>
                      <div className="mt-5 sm:ml-6 sm:mt-0 sm:flex sm:flex-shrink-0 sm:items-center">
                        <Switch
